...
| 2. Tower and enemy foundation | Tower, pooled + lightweight enemies, auto-attacks, run timer | Next |
| 3. LMB active skill | Cursor-aimed cooldown meteor, playable core loop | Pending |
